                        ...
                        {!loading && <div className='mt-2'>
                            ...
                            <div class="card mt-5 mb-3" style={{ width: "95%" }}>
                                ...
                                <div class="card-body">
                                    ...
                                    <div className='d-flex justify-content-end'>  <a target="_blank" rel="noopener noreferrer" href={`${general.articles[7].url}`} class="btn btn-success">Devamını oku...</a> </div>
                                </div>
                            </div>
                            <div class="card mb-3" style={{ width: "95%" }}>
                                ...
                                <div class="card-body">
                                    ...
                                    <div className='d-flex justify-content-end'>  <a target="_blank" rel="noopener noreferrer" href={`${general.articles[8].url}`} class="btn btn-success">Devamını oku...</a> </div>
                                </div>
                            </div>
                            <div class="card mb-3" style={{ width: "95%" }}>
                                ...
                                <div class="card-body">
                                    ...
                                    <div className='d-flex justify-content-end'>  <a target="_blank" rel="noopener noreferrer" href={`${general.articles[9].url}`} class="btn btn-success">Devamını oku...</a> </div>
                                </div>
                            </div>
                            <div class="card" style={{ width: "95%" }}>
                                ...
                                <div class="card-body">
                                    ...
                                    <div className='d-flex justify-content-end'>  <a target="_blank" rel="noopener noreferrer" href={`${general.articles[10].url}`} class="btn btn-success">Devamını oku...</a> </div>
                                </div>
                            </div>
                        </div>}
                    </div>
                                    ...
                                    <div className="row g-0">
                                        ...
                                        <div className="col-md-8">
                                            <div className="card-body">
                                                ...
                                                <p class="card-text fw-bold"> Kaynak : {general.source.name} </p>
