                        ...
                        {!loading && <div className='mt-2'>
                            ...
                            <div className="card mt-5 mb-3" style={{ width: "95%" }}>
                                ...
                                <div className="card-body">
                                    <h5 className="card-title">{science.articles[7].title}</h5>
                                    <p className="card-text fw-bold"> Kaynak : {science.articles[7].source.name} </p>
                                    <div className='d-flex justify-content-end'>  <a target="_blank" rel="noopener noreferrer" href={`${science.articles[7].url}`} className="btn btn-success">Devamını oku...</a> </div>
                                </div>
                            </div>
                            <div className="card mb-3" style={{ width: "95%" }}>
                                ...
                                <div className="card-body">
                                    <h5 className="card-title">{science.articles[8].title}</h5>
                                    <p className="card-text fw-bold"> Kaynak : {science.articles[8].source.name} </p>
                                    <div className='d-flex justify-content-end'>  <a target="_blank" rel="noopener noreferrer" href={`${science.articles[8].url}`} className="btn btn-success">Devamını oku...</a> </div>
                                </div>
                            </div>
                            <div className="card mb-3" style={{ width: "95%" }}>
                                <img src={`${science.articles[9].urlToImage !== null ? science.articles[9].urlToImage : "https://media.istockphoto.com/id/1197671817/tr/foto%C4%9Fraf/siyah-arka-plan-soyut-gri-ve-g%C3%BCm%C3%BC%C5%9F-renk-tasar%C4%B1m%C4%B1-ile-eski-duvar-doku-%C3%A7imento-kirli-gri.jpg?s=612x612&w=0&k=20&c=NBQwzWXb0p0w42mWfbwWWvO1DiNIzFn10xAmsCDpXgU="}`} className="card-img-top" alt="..." />
                                <div className="card-body">
                                    <h5 className="card-title">{science.articles[9].title}</h5>
                                    <p className="card-text fw-bold"> Kaynak : {science.articles[9].source.name} </p>
                                    <div className='d-flex justify-content-end'>  <a target="_blank" rel="noopener noreferrer" href={`${science.articles[9].url}`} className="btn btn-success">Devamını oku...</a> </div>
                                </div>
                            </div>
                            <div className="card" style={{ width: "95%" }}>
                                <img src={`${science.articles[10].urlToImage !== null ? science.articles[10].urlToImage : "https://media.istockphoto.com/id/1197671817/tr/foto%C4%9Fraf/siyah-arka-plan-soyut-gri-ve-g%C3%BCm%C3%BC%C5%9F-renk-tasar%C4%B1m%C4%B1-ile-eski-duvar-doku-%C3%A7imento-kirli-gri.jpg?s=612x612&w=0&k=20&c=NBQwzWXb0p0w42mWfbwWWvO1DiNIzFn10xAmsCDpXgU="}`} className="card-img-top" alt="..." />
                                <div className="card-body">
                                    <h5 className="card-title">{science.articles[10].title}</h5>
                                    <p className="card-text fw-bold"> Kaynak : {science.articles[10].source.name} </p>
                                    <div className='d-flex justify-content-end'>  <a target="_blank" rel="noopener noreferrer" href={`${science.articles[10].url}`} className="btn btn-success">Devamını oku...</a> </div>
                                </div>
                            </div>
                        </div>}
                    </div>
                                    ...
                                    <div className="row g-0">
                                        ...
                                        <div className="col-md-8">
                                            <div className="card-body">
                                                ...
                                                <p className="card-text fw-bold"> Kaynak : {science.source.name} </p>
