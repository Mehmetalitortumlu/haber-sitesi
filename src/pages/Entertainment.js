        ...
        <>
            ...
            <div className='container'>
                <div className="row mt-5 ">
                    ...
                    <div className="col-12 col-md-12 col-lg-8 ">
                        {!loading && filteredentertainment.map((entertainment, i) => (
                            <div key={i} className="col-12 d-flex justify-content-end">
                                <div className="card mb-3" style={{ maxWidth: "900px" }}>
                                    <div className="row g-0">
                                        <div className="col-md-4">
                                            <img src={entertainment.urlToImage != null ? entertainment.urlToImage : "https://media.istockphoto.com/id/1197671817/tr/foto%C4%9Fraf/siyah-arka-plan-soyut-gri-ve-g%C3%BCm%C3%BC%C5%9F-renk-tasar%C4%B1m%C4%B1-ile-eski-duvar-doku-%C3%A7imento-kirli-gri.jpg?s=612x612&w=0&k=20&c=NBQwzWXb0p0w42mWfbwWWvO1DiNIzFn10xAmsCDpXgU="} className="img-fluid h-100 rounded-start" alt="..." />
                                        </div>
                                            ...
                                            <div className="card-body">
                                                ...
                                                <div className='d-flex justify-content-end'>
                                                    <button className='btn btn-success'>
                                                        <a href={entertainment.url} target="_blank" rel="noopener noreferrer" className="card-link ">
            ...
            </div>
            {
                ...
                <div className='text-center mt-5'>
                    <p className='mb-5'>Toplam sonuc : {filteredentertainment.length}
                        <br />
                        Sayfa başına haber: {filteredentertainment.length !== "" && entertainment.articles.length}
