                        ...
                        {!loading && <div className='mt-2'>
                            ...
                            <div className="card mt-5 mb-3" style={{ width: "95%" }}>
                                ...
                                <div className="card-body">
                                    ...
                                    <p className="card-text fw-bold"> Kaynak : {business.articles[7].source.name} </p>
                            ...
                            <div className="card mb-3" style={{ width: "95%" }}>
                                ...
                                <div className="card-body">
                                    ...
                                    <p className="card-text fw-bold"> Kaynak : {business.articles[8].source.name} </p>
                            ...
                            <div className="card mb-3" style={{ width: "95%" }}>
                                ...
                                <div className="card-body">
                                    ...
                                    <p className="card-text fw-bold"> Kaynak : {business.articles[9].source.name} </p>
                            ...
                            <div className="card" style={{ width: "95%" }}>
                                ...
                                <div className="card-body">
                                    ...
                                    <p className="card-text fw-bold"> Kaynak : {business.articles[10].source.name} </p>
                                    <div className='d-flex justify-content-end'>  <a target="_blank" rel="noopener noreferrer" href={`${business.articles[10].url}`} className="btn btn-success">Devamını oku...</a> </div>
                                </div>
                            </div>
                        </div>}
                    </div>
                                    ...
                                    <div className="row g-0">
                                        ...
                                        <div className="col-md-8">
                                            <div className="card-body">
                                                ...
                                                <p className="card-text fw-bold"> Kaynak : {business.source.name} </p>
